...
- **Official-source hunt result:** none of the twelve press-only cases has an official page that automated readers can open (justice.gov, cbi.gov.in, fiscalia.gov.co, fgjem.edomex.gob.mx, gov.br, police.gov.gh all block or refuse). Each now has extra corroboration (state broadcasters, wire copy, a second newspaper). Two known official URLs to open by hand and add: CBI press release cbi.gov.in/press-detail/Nzk1Ng== and the Fiscalía release "Condenados integrantes de red de trata de personas señalados de captar mujeres con engaños para explotarlas sexualmente en Grecia".
- **Corrections from the hunt:** Accra raid site is Adom Estates, Community 25 (Tema area); Medellín convictions were July and December 2025, not a single December verdict; the Brazil deepfake operation is named Operação Modo Selva.
