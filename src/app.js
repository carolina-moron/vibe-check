...
function viewCheck(kind = "") {
  ...
  main.innerHTML = (k ? `
    ...
    <div class="home">
      ...
      <figure class="figure-band" aria-label="Animation: a network expanding from a central point, showing connections and actors">
        <canvas id="figure" aria-hidden="true"></canvas>
        <figcaption class="figure-caption">Fig. 1 — networks expand, bad actors emerge</figcaption>
      </figure>
...
function downloadReport(r, input) {
  ...
  const report = `Vibe Check Report
Generated: ${timestamp}
Result: ${r.tier.label}
Score: ${r.points}/100
...
Report generated by Vibe Check
Source: https://carolina-moron.github.io/job-risk-search
`;
...
function viewTeam() {
  main.innerHTML = `
    ...
    <article class="panel">
      ...
      <p>Vibe Check started as a hackathon project and has grown into a tool that serves job seekers, investors, dating app users, and anyone suspicious of an online interaction.</p>
    </article>
    <article class="panel">
      <h2>Contributors</h2>
