...
const SCAM_TYPES = [
  ...
  { name: "Pig butchering: friendship, then an investment", typ: null,
    how: "A stranger opens with a wrong-number text or a friendly DM, builds trust for weeks, then shares a crypto or trading platform that shows fake profits. When you try to withdraw, there are fees, taxes and deposits, and then silence. Many of these messages are sent by people held in scam compounds.",
    tells: ["a “wrong number” that turns into a friendship", "an app or platform with guaranteed or daily profits", "you must pay to withdraw your own money", "moved to WhatsApp or Telegram early"],
    signals: ["wrong_number_opener", "investment_pitch", "withdrawal_fees", "chat_only_contact"], source: ["FBI IC3, Cryptocurrency investment fraud", "https://www.ic3.gov/PSA/2023/PSA230314"] },
  { name: "Sextortion", typ: null,
    how: "Someone online gets an intimate image or video, sometimes faked, then threatens to send it to family, school or followers unless you pay or send more. Teenagers and young men are the main targets.",
    tells: ["a new contact quickly asks for intimate images", "threats to share images with people you know", "demands for gift cards, crypto or payment apps", "pressure to keep it secret and act now"],
    signals: ["sextortion", "gift_card_crypto", "secrecy", "urgency"], source: ["FBI, Sextortion", "https://www.fbi.gov/how-we-can-help-you/scams-and-safety/common-scams-and-crimes/sextortion"] },
...
const KINDS = {
  conversation: { label: "Conversation or DM", hint: "A chat, DM, text or email thread", fields: ["profileUrl"], text: "The messages", screenshotFirst: true, questions: ["secrecy", "isolation", "urgency", "threats_coercion", "sextortion", "wrong_number_opener", "chat_only_contact", "refuses_video", "romance_money", "verification_code", "deepfake_video_call", "voice_clone_emergency"] },
...
const logosSection = () => `
    <div class="logos" aria-label="Partners and hosts">
      ...
      <a class="logo-item" href="https://ethical-tech-colab.github.io/website/" target="_blank" rel="noopener"><img src="assets/partners/etc.jpg" alt="Ethical Tech CoLab"><span>Ethical Tech CoLab · Data Partner</span></a>
