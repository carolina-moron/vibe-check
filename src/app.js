  ...
  main.innerHTML = `
    ...
    <article class="panel partners">
      ...
      <div class="partner-cols">
        <div><h3>Nonprofit partner</h3><p><strong><a href="https://apneaap.org" target="_blank" rel="noopener">Apne Aap Women Worldwide</a></strong> works to end sex trafficking by organising women and girls in India's most vulnerable communities. Apne Aap brings the frontline: who is being recruited, how, and what a warning looks like from inside a community. VibeCheck brings the tool that turns those warnings into checks anyone can run.</p></div>
