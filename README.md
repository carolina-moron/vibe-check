...
Brand: the Digital Safety Check logo (`assets/logo-mark.svg`, also the favicon) and its two colours, navy `#14264A` for text, rules and fills and logo blue `#2A66B8` for links, actions and state, on beige paper `#F2ECE1` (13:1 and 5:1 contrast).
